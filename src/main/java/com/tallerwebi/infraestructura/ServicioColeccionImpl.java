...
public class ServicioColeccionImpl implements ServicioColeccion {
    ...
    public void guardar(DatosPerfume datosPerfume) {
        ...
        Boolean estaEnMaceracion = (datosPerfume.getEnMaceracion() != null) ? datosPerfume.getEnMaceracion() : false;
        ...
        if (estaEnMaceracion && datosPerfume.getFechaInicio() != null && !datosPerfume.getFechaInicio().trim().isEmpty()) {
